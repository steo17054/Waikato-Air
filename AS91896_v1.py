...
while restart_loop == True:
  standard_fares = {"WELLINGTON": 70, "ROTORUA": 50, "AUCKLAND": 80}
  destination = ""
  next_day = ""
  discount = 0
  percentage_discount = 0
  discount_fare = 0
  #num_seats = random.randint(1,130) #code for generating a number between 1-130
  limit = 130
  ...
  def restart():
    ...
    while restart_bool_loop == True:
      restart_bool = str(input("Would you like to enter for another user? (Type 'YES' or 'NO'): "))
